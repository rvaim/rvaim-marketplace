...
$sourcePath = Join-Path $PSScriptRoot 'windows-launcher.cs'
$outputPath = Join-Path $pluginRoot 'bin\letta-mem-launcher.exe'
$sourceHashPath = Join-Path $pluginRoot 'bin\letta-mem-launcher.source.sha256'
$compilerCandidates = @(
